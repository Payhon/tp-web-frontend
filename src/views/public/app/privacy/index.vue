...
defineOptions({ name: 'PublicAppPrivacyPage' })
...
const contentKey: ContentKey = 'privacy_policy'
...
const dictionary = computed(() =>
  lang.value === 'en-US'
    ? {
        ...
        error: 'Failed to load the privacy policy.'
      }
    : {
        fallbackTitle: '隐私政策',
        empty: '暂未发布内容',
...
.public-page {
  ...
  background:
    radial-gradient(circle at top right, rgba(18, 126, 197, 0.15), transparent 32%),
